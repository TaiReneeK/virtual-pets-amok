...
public class FoodRescuePopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Item avocado = new Item("Avocado", "/images/iAvocado.jpg", new GregorianCalendar(4,8,2018));
		Item bacon = new Item("Bacon", "/images/bacon.jpg", new GregorianCalendar(5,9,2019)); 
		Item bananas = new Item("Bananas", "/images/iBanana.jpg", new GregorianCalendar(5,9,2019));
		Item bread = new Item("Bread", "/images/iBread.jpg", new GregorianCalendar(5,9,2019));
		Item cheese = new Item("Cheese", "/images/iCheese.jpg", new GregorianCalendar(5,9,2019));
		Item chickenBreast = new Item("Chicken Breast", "/images/iChickenBreast.jpg", new GregorianCalendar(5,9,2019));
		Item eggs = new Item("Eggs", "/images/iEggs.jpg", new GregorianCalendar(5,9,2019));
		Item groundBeef = new Item("Ground Beef", "/images/iGroundBeef.jpg", new GregorianCalendar(5,9,2019));
		Item lettuce = new Item("Lettuce", "/images/iLettuce.jpg", new GregorianCalendar(5,9,2019));
		Item milk = new Item("Milk", "/images/iMilk.jpg", new GregorianCalendar(5,9,2019));
		Item potato = new Item("Potato", "/images/iPotato.jpg", new GregorianCalendar(5,9,2019));
		Item salmon = new Item("Salmon", "/images/iSalmon.jpg", new GregorianCalendar(5,9,2019));
		Item strawberry = new Item("Strawberry", "/images/strawberry.jpg", new GregorianCalendar(5,9,2019)); 
		Item tortillas = new Item("Tortillas", "/images/iTortillas.jpg", new GregorianCalendar(5,9,2019));
		...
		Recipe avocadoToast = new Recipe("Strawberry Balsamic Avocado Toast", "Toss sliced strawberries with a drizzle of balsamic vinegar, then pile on top of your avocado toast! The unexpected combination of strawberries and avocados works really well, especially with the rich tartness of balsamic vinegar.", 
				"/images/toast.jpg", breakfast, avocado, bread, strawberry);
		...
		Recipe hashbrownWaffle = new Recipe("Egg & Cheese Hashbrown Waffle", "1) Heat waffle iron on medium-high setting. Spray each side generously with non-stick cooking spray or brush with melted butter. " + 
				...
				"4) *Tip: Turn your oven to the \"warm\" function and place finished waffles on a baking sheet in the oven to keep warm while the rest are cooking.", "/images/waffles.jpg", breakfast, potato, eggs, cheese);
		...
		Recipe lettuceWrap = new Recipe("Chicken, Bacon, Avocado Ranch Lettuce Wrap", "1) Start by seasoning the chicken with salt and pepper, then grill them (you could do stovetop as well). " + 
				...
				"8) Eat it like a taco and enjoy!", "/images/chicken.jpg", lunch, lettuce, chickenBreast, avocado, bacon);
		...
		Recipe scrambledEggs = new Recipe("Scrambled Eggs", "1) Beat eggs, milk, salt and pepper in medium bowl until blended. " + 
				...
				"/images/eggs.jpg", breakfast, eggs, cheese);
		...
		Recipe salmonBurger = new Recipe("Grilled Salmon Burgers with Avocado Salsa", "1) Skin and chop salmon fillet. " + 
				...
				"9) Top burgers with salsa. Serve with or without bun.", "/images/salmon.jpg", dinner, avocado, salmon);
		...
		Recipe tacos = new Recipe("Tacos", "1) Heat oven to 250°F. In medium skillet, brown ground beef and onion over medium heat for 8 to 10 minutes or until beef is thoroughly cooked, stirring frequently. Drain. " + 
				...
				"4) To assemble tacos, layer beef mixture, cheese, lettuce and tomatoes in each taco shell. Serve with salsa; top with sour cream.", "/images/tacos.jpg", dinner, groundBeef, tortillas);
		...
		Recipe teriyakiChicken = new Recipe("Easy Teriyaki Chicken", "1) Season the chicken with a salt and pepper, to taste. Set aside. " + 
				...
				"/images/teriyaki.jpg", dinner, chickenBreast); 
